        ...
        <header className={styles.header}>
          ...
          <div className="settings">
            ...
            <div className="bodcontrols">
              ...
              <span id="removeDesk" onClick={() => setDeleteConfFormVisible(true)}>
            ...
            <Link to={'/desktop/profile'}><img src={user.profileImage} alt={user.realName} onError={(e) => { e.target.onerror = null; e.target.src = '/img/avatar.svg' }}/></Link>
          ...
          { deleteConfFormVisible ? <DeleteConfirmForm visible={deleteConfFormVisible} setVisible={setDeleteConfFormVisible} itemType='escritorio' /> : null }
          { addDeskFormVisible ? <AddDesktopForm visible={addDeskFormVisible} /> : null }
        </header>
