...
export default function ContextualColMenu ({ visible, points, params, desktopColumns, setDesktopColumns, desktops, handleClick, desktopLinks, setDesktopLinks, handleEditable }) {
  ...
  return (
        <div className={
            ...
            <p onClick={() => { pasteLink({ params, desktopLinks, setDesktopLinks }) }}>Pegar</p>
